...
final class AdVariantRepository
{
    ...
    {
        $rawVariants = get_post_meta($adId, AdAbTestMetaKeys::VARIANTS, true);
        ...
        foreach ($rawVariants as $variant) {
            ...
            $variants[] = new AdVariant(
                ...
                description: isset($variant['description']) ? sanitize_textarea_field((string)$variant['description']) : null,
                imageUrl: isset($variant['imageUrl']) ? esc_url_raw((string)$variant['imageUrl']) : null,
                targetUrl: isset($variant['targetUrl']) ? esc_url_raw((string)$variant['targetUrl']) : null,
    ...
    {
        update_post_meta($adId, AdAbTestMetaKeys::WINNER_VARIANT_ID, sanitize_key($variantId));
    }
