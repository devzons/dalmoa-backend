...
final class BusinessPageController
{
    public function __construct(
        private readonly BusinessPageService $service = new BusinessPageService(),
        private readonly BusinessPageTransformer $transformer = new BusinessPageTransformer(),
    ...
    public function show(\WP_REST_Request $request): \WP_REST_Response|\WP_Error
    {
        ...
        if (!$post instanceof \WP_Post) {
            return Response::notFound('Business page not found');
        }
